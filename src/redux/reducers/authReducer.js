...
import {REGISTER_USER, LOGIN_USER, LOGOUT_USER, GET_USER, RECOVER_ACCOUNT, RESET_PASSWORD, SEND_EMAIL_CODE, SEND_PHONE_CODE, VERIFY_EMAIL, VERIFY_PHONE, SET_PHONE_SKIP, SET_IS_AUTHENTICATED, UPDATE_TWO_FACTOR_AUTH, TWO_FACTOR_AUTHENTICATION} from '../constants/types';
