                ...
                <div className="container-md">
                    ...
                    <div className="container__row-center banner-btn">
                        <div className="container__col-2 container__col-offset-1">
                            <Link to="/signup" className=""><button className="lrg-btn">GET STARTED</button></Link>
                        </div>
                        <div className="container__col-2">
                            <Link to="/#products"className=""><button className="lrg-btn-white">MORE INFO</button></Link>
                        </div>
                    </div>
                </div>  
            </div>
