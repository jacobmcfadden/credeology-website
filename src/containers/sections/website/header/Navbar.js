        ...
        <div className='container__row'>
            <Link to="/" className="container__col-3">
              <div className="container__row logo">
                ...
                <Credeology margin="m-logo" size="size-3" fill="fill-light"/>              
              </div>
            </Link>
            ...
            <div className="container__row">
              <div className="container__col-6"><Link to="/auth/login"><button className="btn-std-md-blue">Login</button></Link></div>
              <div className="container__col-6"><Link to="/auth/signup"><button className="btn-frm-md-light">Signup</button></Link></div>
            </div>
            </div>
        </div>
      </div>
